...
exports.run = (client, message, args) => {
    ...
    if (message.mentions.users.size < 2) return message.channel.send(new Discord.RichEmbed().setColor('RANDOM').setTitle('5v5;').setDescription(message.author.tag + ', kullanım: .1vs1 <@kullanıcı> <@kullanıcı> .').setFooter('Emir Erdogan | Youtube', client.user.avatarURL).setTimestamp());
